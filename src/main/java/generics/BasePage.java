...
public class BasePage {
	...
	public static String uniqueRandomRegisterEmailAddress;
	public static String uniqueRandomRegisterPassword;
	...
	public boolean selectFromDropDown(WebElement element, String value) {
